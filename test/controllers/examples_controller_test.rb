...
class ExamplesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create example" do
    assert_difference('Example.count') do
      post examples_url, params: { example: { int: @example.int, str: @example.str, txt: @example.txt } }
    end
  ...
  test "should update example" do
    patch example_url(@example), params: { example: { int: @example.int, str: @example.str, txt: @example.txt } }
